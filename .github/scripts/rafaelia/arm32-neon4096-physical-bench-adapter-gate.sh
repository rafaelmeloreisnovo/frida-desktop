...
grep -q 'TOKEN_VAZIO_SYNCHRONIZED_WALL_MEASUREMENT_REQUIRED' "$MULTI" || failures=$((failures + 1))
...
for object in "$OBJ" "$WORKER_OBJ"; do
...
{
  "schema": "rafaelia.frida.arm32-neon4096.physical-bench-adapter.structural-receipt.v2",
